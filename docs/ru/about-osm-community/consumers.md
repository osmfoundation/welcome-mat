...
* VK (ранее Mail.ru Group) — технологическая компания, которая использует данные OpenStreetMap в своих картографических сервисах.
* Яндекс — использует данные OSM в своих приложениях для некоторых регионов
...
* Ozon, Wildberries — крупные российские маркетплейсы, которые используют данные OSM в своих геосервисах и службах доставки
