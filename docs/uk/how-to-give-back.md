...
- Стати [учасником або підтримувачем](/{{lang}}/about-osm-community/donate-to-osm/), щоб зробити внесок у сталість проєкту. Наприклад, [компанії](https://wiki.osmfoundation.org/wiki/Corporate_Members), що підтримують проєкт.
...
- Брати участь в управлінні та роботі OpenStreetMap Foundation через [робочі групи](/{{lang}}/about-osm-community/working-groups/).
